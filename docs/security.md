...
7. [Chapter 5: Data Protection](#chapter-5-data-protection)
   - [5.1 Secrets Management](#51-secrets-management)
8. [Chapter 6: Compliance & Governance](#chapter-6-compliance--governance)
   - [6.1 Security Audits and Reports](#61-security-audits-and-reports)
9. [Chapter 7: Source Code Security](#chapter-7-source-code-security)
   - [7.1 Code Security](#71-code-security)
...
<img src={require('./image-60.png').default} alt="alt text" width="500" />
...
<img src={require('./image-61.png').default} alt="alt text" width="500" />

<br/>
<br/>

- 🔄 **Links your Services Mesh**
...
<img src={require('./image-62.png').default} alt="alt text" width="500" />
---
...
#### Key Features
- ✅ **tune your level security**: switch on sec, add allowed directories.

<img src={require('./image-56.png').default} alt="alt text" width="250" />


---

- ✅ **Enable OPA validation**: IEnforce OPA to validate your source codee configuration

<img src={require('./image-57.png').default} alt="alt text" width="500" />


---

- ✅ **Audit report**: Audit report will identify the source code security level of the full stack

identify missing Policies

<img src={require('./image-58.png').default} alt="alt text" width="500" />

identify missing Source code Security

<img src={require('./image-59.png').default} alt="alt text" width="500" />
